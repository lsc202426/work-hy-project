        ...
        <div class="content_box containerView-main">
                ...
                <mt-swipe :auto="3000">
                    <mt-swipe-item v-for="(banner, index) in banners" :key="index">
                        <img
                            ...
                            v-lazy="configs.api.public_domain + banner.banner"
            ...
            <div class="product_icon">
                <div class="product_icon_box" v-for="(product, index) in products" :key="index" @click="goProduct(product.mark)">
                    <div class="product_icon_i">
                        <img v-lazy="configs.api.public_domain + product.icon" alt="" />
            ...
            <div class="product">
                <div
                    ...
                    :key="index"
                    @click="getAbout(product.name, product.mark, '3')"
                >
                    <div class="product_i">
                        ...
                        <img v-lazy="configs.api.public_domain + product.head_img" alt="" />
                    </div>
                </div>
            </div>
            <!-- 二维码 -->

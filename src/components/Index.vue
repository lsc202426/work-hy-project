<template>
	<div class="index">
		<div class="content_box">
			...
			<div class="banner">
				<mt-swipe :auto="3000">
					<mt-swipe-item v-for="(banner, index) in banners" :key="index" @click="goProduct(banner.action_value)">
						<img v-lazy="'http://oapi.huyi.cn:6180/' + banner.banner" style="width:100%" alt="" />
					</mt-swipe-item>
				</mt-swipe>
			</div>
			<!-- 产品 -->

			...
			<div class="banner">
				<mt-swipe :auto="3000">
					<mt-swipe-item v-for="(banner,index) in banners" :key="index">
						<img :src="'http://oapi.huyi.cn:6180/'+banner.banner" style="width:100%" alt="">
					</mt-swipe-item>
				</mt-swipe>
			</div>
			<!-- 产品 -->
			<div class="product">
				<div class="product_box" v-for="(product,index) in products" :key="index">
					<div class="product_i">
						<img :src="'http://oapi.huyi.cn:6180/'+product.head_img" alt="">

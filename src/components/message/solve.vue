        ...
        <div class="list_content">
          <div class="img_box" id="img_box">
            ...
            >
              ...
              <div
                class="removeIcon"
                @click="delImg(list.id, list.data_attachments, $event)"
              ></div>
            </div>
...
.solve_box {
  ...
  .solve_title {
    background: url(../../assets/images/message/icon_warning.png) 0.22rem center
      no-repeat;
    ...
    .list_content {
      .img_box {
        ...
        .img_list {
          ...
          .removeIcon {
            background: url(../../assets/images/message/icon_remove.png) center
              center no-repeat;
            background-size: 100% 100%;
            display: block;
            position: absolute;

                ...
                <div class="renew_item pd_common" v-for="(item, index) in renews.list" :key="index">
                    <div class="renew_item_top">
                        ...
                        <div class="item_top_right" v-if="renews.renew == 0">
                            <label for="" class="top_right_lab" @click="checkAll(index, item.list)" :class="{ active: item.allCheck }"
                    ...
                    <div class="renew_item_list">
                        <div class="item_list_box" v-for="list in item.list" :key="list.id">
                            ...
                            <div class="item_list_right">
                                ...
                                <label
                                    for=""
                                    class="list_right_lab"
                                    :class="{ active: checkList.indexOf(list.keyword) >= 0 }"
                                    v-if="renews.renew == 0"
                                >
                                    <input
                                        type="checkbox"
                                        :checked="checkList.indexOf(list.keyword) >= 0"
                                        @click="checkItem(list.keyword, item.list, index)"
                                    />
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="renew_item_top">
                                ...
                                <div class="item_top_right" v-if="renews.renew == 0">
                                    <label
                                        for=""
                                        class="top_right_lab"
                                        @click="checkAll(index, moreList)"
                                        :class="{ active: item.allCheck }"
                                        >全选<input type="checkbox"
                                    /></label>
                                </div>
                            </div>
                                    ...
                                    <div class="item_list_right">
                                        ...
                                        >
                                            <input
                                                type="checkbox"
                                                :checked="checkList.indexOf(list.keyword) >= 0"
                                                @click="checkItem(list.keyword, list, index)"
                                            />
                                        </label>
                                    </div>
                                </div>

<template>
  <div class="public play-success">
    <nav-header title="支付订单" gobackurl="/user"></nav-header>
    <div class="public-main containerView-main">
      <div class="public-main-item">
        ...
        <div class="ps-tips">
          <div class="tips-list" v-if="getProduct.notice">
            <span>{{getProduct.notice[0].name}}</span>
            <p>{{getProduct.notice[0].msg}}</p>
          </div>
        </div>
      </div>

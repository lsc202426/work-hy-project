<template>
    <div class="recruit product-list">
        ...
        <!-- <div class="recruit_top" id="scroll_top">
            ...
            <div class="top_title"><span class="go_index" @click="goback"></span>点招聘</div>
            <div class="search">
            ...
            <div class="product-list-toptips">
                <a href="https://管理机构.招聘/mcategory/policy" class="rule">注册规则</a>
                <a href="javascript:void(0);" @click="goAnchor('#process')" class="guide">注册流程</a>
                <a href="javascript:void(0);" @click="goAnchor('#process_b')" class="mark">关于点招聘</a>
            </div>
        </div> -->
...
export default {
    ...
    data() {
        return {
            ...
            possible_t: false,
            text: '',
            mark: this.$route.query.mark, //产品类型
            product_name: '', //产品名称
            productid: '', //产品id
            status: 0,
            resultList: {},
